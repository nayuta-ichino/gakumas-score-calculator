...
public class CardsJdbcRepository {
     ...
     */
    private static final RowMapper<SQLResultInfomationProjection> SQL_RESULT_INFOMAION_ROW_MAPPER = (rs, i) -> {
        SQLResultInfomationProjection sqlResultInfomation = new SQLResultInfomationProjection();
     ...
     */
    public List<SQLResultInfomationProjection> cardsValueInfomation(List<Integer> idList) {
        String sql = """
                    with selectCards as(
